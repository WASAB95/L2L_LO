...
def main(s1,s2):
    ...
    ## Innerloop simulator
    optimizee_parameters = SignalGeneratorOptimizeeParameters(frequency=5, amplitude=[1, 3], phase=[0, 1], seed=254,
                                                              range=1000)
    ...
    parameters = NNOptimizerParameters(learning_rate=0.01, pop_size=2, neurons=3, batch_size=512, epochs=5,
                                       input_path='/home/wasab/L2L_LO/SG_data_06.csv', schema=[], header=0, target_category=0.5,
                                       n_iteration=50, stop_criterion=np.Inf, seed=6514)
