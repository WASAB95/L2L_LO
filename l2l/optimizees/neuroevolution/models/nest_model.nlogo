...
to setup
  ...
  random-seed 7850
  py:setup py:python3
  let network_code load_python_nest_config "nest_network.py"
...
to-report load_python_nest_config [ #filename ]

  let python_data_line ""
  file-close-all
  carefully [
    file-open #filename
    while [ not file-at-end? ][
      set python_data_line ( word python_data_line file-read-line "\n" )
  ...
  create_nest_agent 0 1 2 4 3 1 0
  report python_data_line
end
...
to go
 ...
 ;]
 check-boundaries
 update-fitness -0.01;-0.008
 if ticks = 15000 [ ;or fitness_value < -10000 [
